...
static uint16_t att_mesh_read_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t offset, uint8_t * buffer, uint16_t buffer_size)
{
    return 0;
}

static int att_mesh_write_callback(hci_con_handle_t connection_handle, uint16_t att_handle, uint16_t transaction_mode, uint16_t offset,const uint8_t *buffer, uint16_t buffer_size)
{
    return 0;
}
...
void ble_mesh_profile_env_init(void)
{
    ...
    att_server_init(att_mesh_read_callback, att_mesh_write_callback);
