...
static void user_packet_handler(uint8_t packet_type, uint16_t channel, const uint8_t *packet, uint16_t size)
{
    ...
    case HCI_EVENT_LE_META:
        ...
        case HCI_SUBEVENT_LE_ENHANCED_CONNECTION_COMPLETE:
            ...
            bt_at_cmd_uart_out_string_with_end_char("TTM:CONNECT\r\n\0");
            break;
        default:
            break;
        }
    ...
    case HCI_EVENT_COMMAND_COMPLETE:
        if (hci_event_command_complete_get_command_opcode(packet) == OPCODE_READ_RSSI)
        {
            ...
            bt_at_cmd_uart_out_string_with_end_char(send_data);
        }
        break;
    ...
    case HCI_EVENT_DISCONNECTION_COMPLETE:
        ...
        gap_set_ext_adv_enable(1, sizeof(adv_sets_en) / sizeof(adv_sets_en[0]), adv_sets_en);
        bt_at_cmd_uart_out_string_with_end_char("TTM:DISCONNECT\r\n\0");
        break;
